...
models.append(MinerModel(model='A741', chips='88', temp_keys='', description='Avalon 741 - 7 TH/s', hashrate_value=7, hashrate_unit='GH/s', high_temp=90, default_frequency=648, max_fan_rpm=0, watts=1150))
