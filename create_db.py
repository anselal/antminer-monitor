...
models.append(MinerModel(model='S9', chips='63,63,63', temp_keys='temp2_', description='Bitcoin Miner 13.5 TH/s', hashrate_value=13.5, hashrate_unit='TH/s', high_temp=80, default_frequency=600, max_fan_rpm=7125, watts=1323))
...
models.append(MinerModel(model='A741', chips='88', temp_keys='', description='Avalon 741 - 7 TH/s', hashrate_value=7, hashrate_unit='GH/s', high_temp=90, default_frequency=708, max_fan_rpm=0, watts=1150))
models.append(MinerModel(model='GekkoScience', chips='1', temp_keys='', description='GekkoScience 2PAC Rev2 BM1384', hashrate_value=15, hashrate_unit='MH/s', high_temp=0, default_frequency=200, max_fan_rpm=0, watts=5))
